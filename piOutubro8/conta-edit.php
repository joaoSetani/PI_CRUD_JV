        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card ">
              ...
              <form method="post" action="conta-edit.php" id="salvar" class="form-horizontal" novalidate="novalidate">
                ...
                <div class="card-body ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input type="email" name="email" class="form-control" value="<?php echo $email; ?>" required="true">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input type="password" name="senha" class="form-control" value="<?php echo $senha; ?>" required="true">
                      </div>
                    </div>
                  </div>
                </div>
